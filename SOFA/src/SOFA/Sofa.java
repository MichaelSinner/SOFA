  ...
  JMenuBar menuBar;
    ...
    {   
        ...
        menuBar.add(menu);
            ...
            menuItem = new JMenuItem("New Project...",new ImageIcon(this.getClass().getResource("/images/OpenFile.png")));
         ...
         //----------------------------------------------------------------------------------
            menuItem = new JMenuItem("Open Project...", new ImageIcon(this.getClass().getResource("/images/OpenFile.png")));
            menuItem.setMnemonic(KeyEvent.VK_F);
         ...
         //----------------------------------------------------------------------
            ...
            menu.addSeparator();
         //----------------------------------------------------------------------
            menuItem = new JMenuItem("Save",new ImageIcon(this.getClass().getResource("/images/SaveResult.png")));
         ...
         //----------------------------------------------------------------------
            menuItem = new JMenuItem("Save As...",new ImageIcon(this.getClass().getResource("/images/LoadResult.png")));
            menuItem.setEnabled(false);
            ...
            menu.addSeparator();
          //----------------------------------------------------------------------
            menuItem = new JMenuItem("Exit",new ImageIcon(this.getClass().getResource("/images/Exit.png")));
    ...
    {   
       // ConfigFileRW LoadSettingValue = new ConfigFileRW();
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(Sofa.class.getResource("/images/IconApplication.png")));
        
        ImageIcon iconZoomin  = new ImageIcon(this.getClass().getResource("/images/ZoomIn.png"));
        ImageIcon iconZoomout = new ImageIcon(this.getClass().getResource("/images/Zoomout.png"));
        //ImageIcon iconScreen  = new ImageIcon(this.getClass().getResource("/images/ResizeImage.png"));
        ImageIcon iconExecute = new ImageIcon(this.getClass().getResource("/images/Run.png"));
